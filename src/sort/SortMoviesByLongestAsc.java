 ...
 */
public final class SortMoviesByLongestAsc implements Comparator<MovieInputData> {
    /**
     * Method used to compare in ascending order the total duration of two movies
