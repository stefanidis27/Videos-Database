 ...
 */
public final class SortSerialsByViewsAsc implements Comparator<SerialInputData> {
    /**
     * Method used to compare in ascending order the total views of two serials
