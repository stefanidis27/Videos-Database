...
import sort.SortSerialsByRatingAsc;
import sort.SortSerialsByRatingDesc;

import java.io.IOException;
import java.util.ArrayList;

/**
 * Class used for the query serials by rating
 */
public final class QuerySerialsRating {
    /**
    ...
    public static void querySerials(final Input input, final int i, final int id,
        ...
        if (input.getCommands().get(i).getSortType().equals("asc")) {
            copy.sort(new SortSerialsByRatingAsc());
        } else {
            copy.sort(new SortSerialsByRatingDesc());
        }
